...
class Component(LemonElement, PhraseElement):
	"""
    ...
    def __init__(
 	   self,
 	   element: LexicalEntry = None,
 	):
 		self.set_element(element)

 	def set_element(self, element: LexicalEntry = None):
...
class Form(LemonElement):
    ...
    def __init__(
 	   self,
 	   formVariant: Form = None,
 	   representation: str = None,
 	   writtenRep: str = None,
 	):
 		self.set_formVariant(formVariant)
 		self.set_representation(representation)
 		self.set_writtenRep(writtenRep)

 	def set_formVariant(self, formVariant: Form = None):
 		self._formVariant = formVariant

 	def set_representation(self, representation: str = None):
 		self._representation = representation

 	def set_writtenRep(self, writtenRep: str = None):
 		self._writtenRep = writtenRep
...
class HasLanguage(LemonElement):
	"""
...
class HasPattern(LemonElement):

    def __init__(
 	   self,
 	   pattern: MorphPattern=None
 	):
	   	self.set_pattern(pattern)

	def set_pattern(pattern: MorphPattern = None):
...
class LemonElement(object):
    ...
    def __init__(
 	   self,
 	   property: PropertyValue=None
 	):
    	self.set_property(property)

    def set_property(self, property: PropertyValue = None):
...
class LexicalEntry(LemonElement, HasLanguage, HasPattern):
	"""
    ...
    def __init__(
 	   self,
 	   abstractForm: Form = None,
 	   canonicalForm: Form = None,
 	   lexicalForm: Form = None,
 	   lexicalVariant: LexicalEntry = None,
	...
	def set_lexicalForm(self, lexicalForm: Form = None):
		self._lexicalForm = lexicalForm

	def set_lexicalVariant(self, lexicalVariant: LexicalEntry = None):
		self._lexicalVariant = lexicalVariant

	def set_otherForm(self, otherForm: Form = None):
		self._otherForm = otherForm

	def set_phraseRoot(self, phraseRoot: Node = None):
		self._phraseRoot = phraseRoot

	def set_sense(self, sense: LexicalSense = None):
		self._sense = sense
...
class LexicalSense(LemonElement):
	"""
	...
	def set_altRef(altRef: LexicalSense = None):
		self._altRef = altRef

 	def set_broader(broader: LexicalSense = None):
		self._broader = broader

	def set_narrower(narrower: LexicalSense = None):
		self._narrower = narrower

 	def set_condition(condition: LexicalCondition = None):
		self._condition = condition

	def set_context(context: LexicalContext = None):
		self._context = context

 	def set_definition(definition: SenseDefinition = None):
		self._definition = definition

	def set_equivalent(equivalent: LexicalSense = None):
		self._equivalent = equivalent

	def set_example(example: UsageExample = None):
		self._example = example

	def set_incompatible(incompatible: LexicalSense = None):
		self._incompatible = incompatible

	def set_isA(isA: Argument = None):
		self._isA = isA

	def set_isReferenceOf(isReferenceOf: LexicalSense = None):
		self._isReferenceOf = isReferenceOf

	def set_isSenseOf(isSenseOf: LexicalEntry = None):
		self._isSenseOf = isSenseOf

	def set_objOfProp(objOfProp: Argument = None):
		self._objOfProp = objOfProp

	def set_reference(reference = None):
		self._reference = reference

	def set_propertyDomain(propertyDomain = None):
		self._propertyDomain = propertyDomain

	def set_propertyRange(propertyRange = None):
		self._propertyRange = propertyRange

	def set_semArg(semArg: Argument = None):
		self._semArg = semArg

	def set_senseRelation(senseRelation: LexicalSense = None):
		self._senseRelation = senseRelation

	def set_subsense(subsense: LexicalSense = None):
		self._subsense = subsense

	def set_subjOfProp(subjOfProp: Argument = None):
...
class Lexicon(LemonElement):
    ...
    def set_entry(self, entry: LexicalEntry = None):
    	self._entry = entry
...
class PhraseElement(LemonElement):
	"""
